...
SECRET_KEY = 'django-insecure-tduh@%vfc)k6q5o(vtp)z#=p++rq!a@noabqz*6svqwnw8*4d('
...
MIDDLEWARE = [
    ...
    'pages.middleware.OrganizerLockMiddleware', 
]
...
EMAIL_BACKEND =     "pages.backend.email_backend.EmailBackend"
